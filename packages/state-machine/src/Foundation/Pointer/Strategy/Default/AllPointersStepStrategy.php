...
final class AllPointersStepStrategy implements PointersSelectionStrategy
{
    public function select(Pointers $pointers): array
    {
        return array_values(array_map(
            static fn(Pointer $pointer): PointerExecutionPlan => PointerExecutionPlan::step($pointer),
            $pointers->pointers,
        ));
    }
}
