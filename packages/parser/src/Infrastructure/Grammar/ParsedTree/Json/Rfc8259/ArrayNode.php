...
class ArrayNode extends Node
{
    ...
    /** @var SequenceAttribute<NodeAttribute<PrimitiveNode|ObjectNode|ArrayNode>|GroupAttribute|StructureAttribute|PrimitiveNode|ObjectNode|ArrayNode> */
    ...
    {
        $this->items->addUnit(NodeAttribute::fromNode($node->setParent($this)));
        return $this;
    }
