...
class LeadingCommentNode extends SequenceNode
{
    ...
    /** @var NodeAttribute<LineCommentNode|BlockCommentNode> */
    public NodeAttribute $comment { get => $this->attributes[1]; }
    public RawGroupAttribute $trailingWs { get => $this->attributes[2]; }

    public static function create(?string $leadingWs, LineCommentNode|BlockCommentNode $comment): self
    {
        $node = new self(
            name: 'leadingComment',
    ...
    public function getNodeComment(): LineCommentNode|BlockCommentNode
    {
        /** @var LineCommentNode|BlockCommentNode $node */
        $node = $this->comment->node;
        return $node;
    }

    public function setNodeComment(LineCommentNode|BlockCommentNode $value): self
    {
