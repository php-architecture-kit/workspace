...
class ArrayNode extends SequenceNode
{
    ...
    /** @var GroupAttribute<TrailingWsNode|LineCommentNode|BlockCommentNode|EmptyLineNode|LeadingWsNode|InlineWsNode> */
