...
class QuotedSectionHeaderNode extends GroupNode
{
    /** @param NodeAttributeInterface[] $attributes */
    public static function create(array $attributes = []): self
    {
        return new self(
            name: 'quotedSectionHeader',
    ...
    public function addNode(SubsectionNameNode $node): self
    {
     ...
     * @return array<SubsectionNameNode>
     */
