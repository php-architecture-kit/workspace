...
class RawGroupAttribute implements RawAttributeInterface
{
    use MetaTrait;
    use TagsTrait;

    /**
     * @param RawAttributeInterface[] $raws
    ...
    {
        return implode('', array_map(static fn(RawAttributeInterface $raw): string => $raw->__toString(), $this->raws));
    }
}
